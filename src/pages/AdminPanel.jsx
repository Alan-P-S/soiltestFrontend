        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="card bg-base-100 border border-base-300 shadow-sm">
            <div className="card-body">
              ...
              <p className="text-4xl font-bold">{stats.totalSamples}</p>
          ...
          <div className="card bg-base-100 border border-base-300 shadow-sm">
            <div className="card-body">
              ...
              <p className="text-4xl font-bold">{stats.pendingResults}</p>
              <p className="text-sm text-base-content/60">
          ...
          <div className="card bg-base-100 border border-base-300 shadow-sm">
            <div className="card-body">
              ...
              <p className="text-4xl font-bold">{stats.completedResults}</p>
              <p className="text-sm text-base-content/60">
        ...
        <div className="mt-10 card bg-base-100 border border-base-300">
          <div className="card-body">
            ...
            <p className="text-sm text-base-content/70">
              Monitor pending samples regularly to ensure timely soil report
              delivery. Detailed analytics and lab-wise reports can be added
              here.
            </p>
          </div>
        </div>
